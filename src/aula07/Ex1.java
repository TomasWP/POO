        ...
        try{
            do{
                do{
                    ...
                    System.out.println("7 - Cor de uma figura");
                    System.out.println("0 - Sair");
                    opcao = sc.nextInt();
                }while(!UserInput.in_between(opcao, 0, 7));
                ...
                switch (opcao){
                    case 1:
                        ...
                        switch(opcao_2){
                            case 1:
                                ...
                                String cor_circulo = sc.next();
                                Circulo novo_circulo = new Circulo(raio,cor_circulo);
                            ...
                            case 2:
                                ...
                                System.out.println("Insira a cor!");
                                String cor_retangulo = sc.next();
                                Retangulo novo_retangulo = new Retangulo(comprimento, altura,cor_retangulo);
                            ...
                            case 3:
                                ...
                                System.out.println("Insira a cor!");
                                String cor_triangulo = sc.next();
                                Triangulo novo_triangulo = new Triangulo(lado_1, lado_2, lado_3, cor_triangulo);
                    ...
                    case 3:
                        ...
                        switch(opcao_2){
                            case 1:
                                ...
                                double raio = sc.nextDouble();
                                System.out.println("Insira a cor!");
                                String mudar_cor_circulo = sc.next();
                                circulos.get(circulos.size() - 1).setRaio(raio);
                                circulos.get(circulos.size() - 1).setCor(mudar_cor_circulo);
                                System.out.println("");
                            ...
                            case 3:
                                ...
                                double lado_3 = sc.nextDouble();
                                System.out.println("Insira a cor!");
                                String mudar_cor_triangulo = sc.next();
                                ...
                                triangulos.get(triangulos.size() - 1).setCor(mudar_cor_triangulo);
                                System.out.println("");
                    ...
                    case 7:
                        do{
                            System.out.println("1 - Cor do Circulo");
                            System.out.println("2 - Cor do Retangulo");
                            System.out.println("3 - Cor do Triangulo");
                            System.out.println("0 - Voltar ao Menu Anterior");
                            opcao_2 = sc.nextInt();
                        }while(!UserInput.in_between(opcao_2, 0, 3));
                        switch(opcao_2){
                            case 1:
                                ...
                                System.out.println("Cor do Círculo: " + circulos.get(circulos.size() - 1).getCor());
                                break;
                            case 2:
                                if (retangulos.size() <= 0) {
                                    System.out.println("Nenhum retangulo foi criado!");
                                ...
                                System.out.println("Cor do Retangulo: " + retangulos.get(retangulos.size() - 1).getCor());
                                break;
                            case 3:
                                if (triangulos.size() <= 0) {
                                    System.out.println("Nenhum triangulo foi criado!");
                                ...
                                System.out.println("Cor do Triangulo: " + triangulos.get(triangulos.size() - 1).getCor());
                                break;
                        default:
                            break;
                    }
